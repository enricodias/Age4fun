...
67 =>array( 'D-Global Bar Manager' , 'act=op&code=gbar' ),
...
$PAGES[count($PAGES)+1] = array(
				 1 => array( 'File Manager'    , 'act=upload'         ),
				 2 => array( 'Configuration'   , 'act=upload&code=01' ),
			 );
$CATS[count($CATS)+1] = "Upload Manager";							 
$DESC[count($DESC)+1] = "Manage The Uploaded Files";
