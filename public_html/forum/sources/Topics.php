    ...
    function Topics()
    {
		...
		while ( $row = $DB->fetch_row() )
		{
			...
			if ($post_count == 1) // and $first == 0
			{
								...
								'post_css'	=> ($post_count % 3 ? 'post1' : 'post2'),
								// You may want to change the post icon here or completly remove it
								'post_icon'	=> '<img src="http://www.age4fun.com/forum/html/emoticons/smile.gif" alt="" /> ',
								// Paste your Google ad code inside the single quotes
								'post'		=> '
<script type="text/javascript"><!--
google_ad_client = "pub-9249789260519814";
google_ad_width = 300;
  ...
  src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
				...
				$bot_poster = array (
									 ...
									 */
										...
										'avatar'		=> $std->get_avatar( 'http://forum.age4fun.com/google_sm.gif', $ibforums->member['view_avs'], '128x53' ),
									 ...
									 */
										...
										//'website_icon'	=> '<a href="https://adwords.google.com/select/OnsiteSignupLandingPage?client=ca-pub-9249789260519814&referringUrl=http://www.age4fun.com/forum/&hl=pt&gl=BR" target="_blank"><{P_WEBSITE}></a>',
									);
				...
				$replace = array (	'search'  => array	("<a href='{$ibforums->base_url}act=Post&amp;CODE=06&amp;f={$ibforums->input[f]}&amp;t={$ibforums->input[t]}&amp;p='><{P_QUOTE}></a>",
									...
									'replace' => array	('',
														 '<b>Age4fun.com is a ad supported site.</b>'
														)
								 );
