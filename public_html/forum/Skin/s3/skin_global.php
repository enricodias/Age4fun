...
<table width="100%" id="userlinks" cellspacing="6">
   <tr>
    ...
    <td align='right'>
   <b><a href='{$ibforums->base_url}act=UserCP&amp;CODE=00' title='{$ibforums->lang['cp_tool_tip']}'>{$ibforums->lang['your_cp']}</a></b> &middot;
   <b><a href='index.php?act=upload' title='Enviar Arquivos'></a></b>
...
<!--IBF.BANNER-->
<table width="100%" cellspacing="6" cellpadding="0" id="submenu">
  <tr> 
    <td>
      <div align="left"><a href='{$ibforums->base_url}' title='Board Home'><img src='{$ibforums->vars['img_url']}/logo.gif' alt='Powered by Age4fun.com' border="0" /></a></div>
    </td>
  </tr>
</table>
<!-- IE6/Win TABLE FIX -->
...
<tr>
 ...
 <td align="right">
   <a href='{$ibforums->base_url}act=Search&amp;f={$ibforums->input['f']}'><img src="{$ibforums->vars['img_url']}/atb_search.gif" border="0" alt="Pesquisar por Posts e Tópicos." /></a><a href='{$ibforums->base_url}act=Members'><img src="{$ibforums->vars['img_url']}/atb_members.gif" border="0" alt="Ver a lista de membros." /></a><a href='{$ibforums->base_url}act=calendar'><img src="{$ibforums->vars['img_url']}/atb_calendar.gif" border="0" alt="Canlendario de eventos." /></a><a href='{$ibforums->base_url}act=Help'><img src="{$ibforums->vars['img_url']}/atb_help.gif" border="0" alt="Como usar o fórum, arquivos de ajuda." /></a><!--IBF.CHATLINK-->
<br />{$ibforums->globalbar}
   <!--IBF.TSLLINK-->
 </td>
</tr>
</table>
...
&nbsp; &nbsp;&nbsp;<img src="{$ibforums->vars['img_url']}/atb_members.gif" border="0" alt="" />&nbsp;<a href='{$ibforums->base_url}act=upload'>D-Upload</a>
EOF;
}
...
global $ibforums;
return <<<EOF
<a href="javascript:chat_pop();"><img src="{$ibforums->vars['img_url']}/atb_chat.gif" border="0" alt="Chat!" /></a>
EOF;
}
...
global $ibforums;
return <<<EOF
<a href='{$ibforums->base_url}act=chat'><img src="{$ibforums->vars['img_url']}/atb_chat.gif" border="0" alt="Chat!" /></a>
EOF;
}
