...
global $ibforums;
return <<<EOF
<a href='{$ibforums->base_url}act=chat'><img src="{$ibforums->vars['img_url']}/atb_chat.gif" border="0" alt="Live Chat" /></a>
EOF;
}
...
global $ibforums;
return <<<EOF
<a href="javascript:chat_pop();"><img src="{$ibforums->vars['img_url']}/atb_chat.gif" border="0" alt="Live Chat" /></a>
EOF;
}
...
<table width="100%" cellspacing="6" cellpadding="0" id="submenu">
  <tr> 
    <td>
      <div align="left"><a href='{$ibforums->base_url}' title='Board Home'><img src='{$ibforums->vars['img_url']}/logo.gif' alt='Powered by Invision Power Board' border="0" /></a></div>
    </td>
  </tr>
</table>
<!-- IE6/Win TABLE FIX -->
...
<tr>
 ...
 <td align="right">
   <a href='{$ibforums->base_url}act=Search&amp;f={$ibforums->input['f']}'><img src="{$ibforums->vars['img_url']}/atb_search.gif" border="0" alt="Search for Messages and Topics" /></a><a href='{$ibforums->base_url}act=Members'><img src="{$ibforums->vars['img_url']}/atb_members.gif" border="0" alt="View the Member List" /></a><a href='{$ibforums->base_url}act=calendar'><img src="{$ibforums->vars['img_url']}/atb_calendar.gif" border="0" alt="Forum Calendar & Events" /></a><a href='{$ibforums->base_url}act=Help'><img src="{$ibforums->vars['img_url']}/atb_help.gif" border="0" alt="How to use the Forum & Help Files" /></a><!--IBF.CHATLINK-->
 </td>
</tr>
</table>
<!--CS.TEMPLATE.LINKS-->
