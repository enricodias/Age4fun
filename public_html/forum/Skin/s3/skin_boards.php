...
<tr>
    	...
    	<tr>
          <td class='row2' width='5%' valign='middle'><{silverbirthday}></td>
...
<tr>
    	...
    	<tr>
          <td width="5%" class='row2'><{silverchat}></td>
          <td class='row4' width='95%'>
...
<tr>
    	...
    	<tr>
          <td class='row2' width='5%' valign='middle'><{silvercalendar}></td>
...
<div align='right'> 
  <table width="100%" cellpadding="4">
    <tr> 
      <td width="23%" class="skinby"> 
        <div align="left"><a href="http://www.nfh.org.uk" target="_blank">Skin 
          by NFHiB</a></div>
      </td>
      <td width="77%" class="skinby"> 
        <div align="right"><a href="{$ibforums->base_url}act=Login&amp;CODE=06">{$ibforums->lang['d_delete_cookies']}</a> 
          &middot; <a href="{$ibforums->base_url}act=Login&amp;CODE=05">{$ibforums->lang['d_post_read']}</a></div>
      </td>
    </tr>
  </table>
</div></div>
...
<table border="0" cellspacing="0" cellpadding="0" width="10%" align="right">
  <tr> 
    <td width="83%" ><div align="right"><a href="javascript:scroll(0,0);"><img src='{$ibforums->vars['img_url']}/top.gif' border="0" alt="Go to Top" /></a> 
</div>
    </td>
  </tr>
</table>
