...
echo "<center><font face='Verdana' size='1'>Não foi possivel apagar o comentario.</font></center>";
} else {
echo "<center><font face='Verdana' size='1'>Sucesso! Comentario apagado do Banco de Dados!</font><br>";
   print "<font face='Verdana' size='2'>Voltando...</center><META HTTP-EQUIV=\"Refresh\" content=\"1;URL=../principal.php\">";
}
}
