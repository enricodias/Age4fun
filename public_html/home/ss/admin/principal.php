...
print "<font size=3 face=Verdana>ATENÇÃO! VOCÊ AINDA NÃO DELETOU O ARQUIVO INSTALAR.PHP QUE SE ENCONTRA NA PASTA PRINCIPAL DO SCRIPT.</FONT><BR><br>";
print "<font size=3 face=Verdana> É MOTIVO DE SEGURANÇA QUE APAGUE O ARQUIVO O QUANTO ANTES DEPOIS DA INSTALAÇÃO.</FONT>";
} else {
include "..config.php";
...
?>
<br><br><center><font size=2 face=verdana>Novidades/Notícias/Atualizações do Script via Internet</font><Br>
