...
<body background="http://www.age4fun.com/home/arquivos/00001.jpg"><table width="100" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="277"> 
      <?
if(!isset($pg) ){
...
?>
      ...
      ?>
        <tr>
          <td height="15" bgcolor="E7E7E7"><font color="<? echo $cortexto?>" size="<? echo $tfonte?>" face="<? echo $fonte?>"><? echo "&nbsp;<strong>Código</strong>: $imagens[$i]";?></font></td>
        </tr>
        <tr>
